...
fun pinging() {
    ...
    if (os.contains("windows", ignoreCase = true)) {
        commands = arrayOf("ping", optionalip)
    }
    else {
        commands = arrayOf("ping", optionalargs, optionalip)
        printargs = " arguments,"
    }
    ...
    println("Here is the standard output of the command [command,$printargs ip/address] $aerial:\n")
    var s: String? = null
